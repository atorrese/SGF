...
var column_basic =document.getElementById("column-basic")
    if(column_basic){
      column_basic.innerHTML = "";
...
var ethCoin1 = document.querySelector("#ethCoin1");
if(ethCoin1){
  var chart1 = new ApexCharts(ethCoin1, options1);
  chart1.render();
...
var donut_update = document.getElementById("donut-update");
if(donut_update){
  donut_update.innerHTML = "";
